...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_xls_import'] = $this->language->get('text_xls_import');
		...
		$data['text_bulk_upload'] = $this->language->get('text_bulk_upload');
		$data['text_stock_upload'] = $this->language->get('text_stock_upload');
		...
		$data['text_dailydelivery_products'] = $this->language->get('text_dailydelivery_products');
		$data['text_manage_enquiry'] = $this->language->get('text_manage_enquiry');
		...
		$data['xls_import'] = $this->url->link('tool/xls_import', 'token=' . $this->session->data['token'], 'SSL');
		$data['export'] = $this->url->link('tool/export', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['stock_upload'] = $this->url->link('tool/export_import', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['manage_enquiry'] = $this->url->link('catalog/dailydeliveryproducts', 'token=' . $this->session->data['token'], 'SSL');
