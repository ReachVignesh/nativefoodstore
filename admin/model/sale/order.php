...
class ModelSaleOrder extends Model {
	...
	/*
		Author : Mohan
		Description : Added getMissingOrderTotals() to get total number of missing orders
		Missing Orders */
	public function getMissingOrderTotals() {
		$query = $this->db->query("SELECT COUNT(order_status_id) AS missing_count FROM " . DB_PREFIX . "order WHERE order_status_id = 0");

		return $query->row['missing_count'];
	}
