...
<div class="container">
  ...
  <div style="page-break-after: always;">
    <h1><?php echo str_replace(':', '', $text_order_id); ?> #<?php echo $order['order_id']; ?></h1>
    <table class="table table-bordered">
      ...
      <tbody>
        <tr>
          ...
          <td style="width: 50%;"><b><?php echo $text_date; ?></b> <?php echo $order['date_added']; ?><br />
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        <tr>
          ...
          <td><address>
            <b><?php echo $order['shipping_address']; ?></b>
            </address></td>
        </tr>
      </tbody>
    </table>
