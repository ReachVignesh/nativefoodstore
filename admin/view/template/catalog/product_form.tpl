        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-product-code"><?php echo $entry_product_code; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="product_code" value="<?php echo $product_code; ?>" placeholder="<?php echo $entry_product_code; ?>" id="input-product-code" class="form-control" />
                </div>
              </div>         
              <div class="form-group required">
