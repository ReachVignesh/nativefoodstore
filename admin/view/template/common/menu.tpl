<ul id="menu">
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
      ...
      <!--<li><a class="parent"><?php echo $text_dailydelivery_products; ?></a>-->
        <ul>
          <li><a href="<?php echo $manage_enquiry; ?>"><?php echo $text_manage_enquiry; ?></a></li>
        </ul>
      </li>
    </ul>
  </li>
  ...
  <li id="reports"><a class="parent"><i class="fa fa-bar-chart-o fa-fw"></i> <span><?php echo $text_reports; ?></span></a>
    ...
    <li id="reports"><a class="parent"><i class="fa fa-bar-chart-o fa-fw"></i> <span><?php echo $text_bulk_upload; ?></span></a>
      <ul>
        <li><a href="<?php echo $stock_upload; ?>"><?php echo $text_stock_upload; ?></a></li>
      </ul>
    </li>
  </li>
</ul>
