...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$message = strip_tags($this->request->post['enquiry']). "\n\n";
		...
		$data['telephone_no'] = $this->config->get('config_telephone');
		$data['fax'] = $this->config->get('config_fax');
		$data['open'] = nl2br($this->config->get('config_open'));
		$data['comment'] = $this->config->get('config_comment');
		$data['email_id'] = $this->config->get('config_email');
	...
	protected function validate() {
		...
		if ((utf8_strlen($this->request->post['telephone']) <= 9) || (utf8_strlen($this->request->post['telephone']) > 10)) {
