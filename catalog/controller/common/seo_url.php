	...
	public function index() {
		...
		if (isset($this->request->get['_route_'])) {
			...
			foreach ($parts as $part) {
				...
				WHERE LOWER(keyword) = lower('" . $this->db->escape($part) . "')");
				...
				if ($query->num_rows) {
					...
					//For Special Offers
					if ($url[0] == 'product/special') {
						$this->request->get['product/special'] = $url[0];
					}
			...
			if (!isset($this->request->get['route'])) {
				...
				}elseif (isset($this->request->get['product/special'])) {
