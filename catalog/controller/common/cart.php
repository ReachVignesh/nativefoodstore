...
class ControllerCommonCart extends Controller {
	public function index() {
		...
		$data['text_minimum_order_amt'] = sprintf($this->language->get('text_minimum_order_amt'), MINIMUM_ORDER_VALUE);
		$data['text_courier_charges'] = $this->language->get('text_courier_charges');
		...
		if(isset($this->session->data['coupon_check'])){
			$prod = $this->cart->getProducts_special();
		}
		else{
			$prod = $this->cart->getProducts();	
		}
