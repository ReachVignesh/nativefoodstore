...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		$data['entry_alternate_no'] = $this->language->get('entry_alternate_no');
	...
	public function validate() {
		...
		if ($this->request->post['postcode'] == '' && (utf8_strlen(trim($this->request->post['postcode'])) < 2 || utf8_strlen(trim($this->request->post['postcode'])) > 10)) {
			$this->error['postcode'] = $this->language->get('error_postcode');
		}
