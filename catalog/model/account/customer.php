...
class ModelAccountCustomer extends Model {
	public function addCustomer($data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "customer SET address_id = '" . (int)$address_id . "',  customer_code = '" . $customer_code . "' WHERE customer_id = '" . (int)$customer_id . "'");
		...
		if (!$customer_group_info['approval']) {
			$message .= sprintf($this->language->get('text_login'), $customer_code) . "\n";
		} else {
