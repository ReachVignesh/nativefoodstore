  ...
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <div class="form-group required">
        ...
        <input type="text" name="firstname" value="<?php echo $firstname; ?>" placeholder="<?php echo $entry_firstname; ?>" id="input-payment-firstname" class="form-control uppercase" />
      </div>
      <!--<div class="form-group required">
      ...
      <div class="form-group">
        <label class="control-label" for="input-payment-fax"><?php echo $entry_alternate_no; ?></label>
        <input type="text" name="fax" value="<?php echo $fax; ?>" placeholder="<?php echo $entry_alternate_no; ?>" id="input-payment-fax" class="form-control" />
      </div>
  ...
  <div class="col-sm-6">
    <fieldset id="address">
      ...
      <div class="form-group required">
        ...
        <textarea rows="4" name="address_1" value="<?php echo $address_1; ?>" placeholder="<?php echo $entry_address_1; ?>" id="input-payment-address-1" class="form-control uppercase"></textarea>
      </div>
      <!--<div class="form-group">
      ...
      <div class="form-group required">
        <label class="control-label" for="input-payment-city"><span style="color:red;">*</span> <?php echo $entry_city; ?></label>
        <input type="text" name="city" value="<?php echo $city; ?>" placeholder="<?php echo $entry_city; ?>" id="input-payment-city" class="form-control uppercase" />
      </div>
      <div class="form-group required">
