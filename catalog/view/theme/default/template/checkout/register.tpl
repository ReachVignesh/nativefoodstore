  ...
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <div class="form-group required">
        ...
        <input type="text" name="firstname" value="" placeholder="<?php echo $entry_firstname; ?>" id="input-payment-firstname" class="form-control uppercase" />
      </div>
      <!--<div class="form-group required">
      ...
      <div class="form-group">
        ...
        <input type="text" name="fax" value="" placeholder="<?php echo $entry_alternate_no; ?>" id="input-payment-fax" class="form-control" />
      </div>
  ...
  <div class="col-sm-6">
    <fieldset id="address">
      ...
      <div class="form-group required">
        ...
        <textarea rows="4" name="address_1" value="" placeholder="<?php echo $entry_address_1; ?>" id="input-payment-address-1" class="form-control uppercase"></textarea>
      </div>
      <!--<div class="form-group">
      ...
      <div class="form-group required">
        ...
        <input type="text" name="city" value="" placeholder="<?php echo $entry_city; ?>" id="input-payment-city" class="form-control uppercase" />
      </div>
      <div class="form-group required">
