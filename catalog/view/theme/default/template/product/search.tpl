...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="button-group searchbuttongroup">
      <button type="button"  data-toggle="modal" data-target="#quickView" href="<?php echo $product['quickhref']; ?>" class="shopNwBtn"><i class="fa fa-search-plus"></i><span class="hidden-xs hidden-sm hidden-md"> Quick View</span></button>
      <button type="button" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart"></i></button>                
      </div>  
      <div class="caption">
        <div class="prodDet">
          <?php if($product['manufacturer']){?>
          <p class="brndName"><!--<?php echo $text_manufacturer; ?> --><span><a href="<?php echo HTTP_SERVER.$product['manufacturer']; ?>"><?php echo $product['manufacturer']; ?></a></span></p>
          <?php } ?>
        ...
        <?php } ?>
         <!--<a data-toggle="modal" data-target="#quickView" href="<?php echo $product['quickhref']; ?>" class="shopNw">Quick View</a>-->
         <ul class="catSize cf">
